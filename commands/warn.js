...
module.exports.run = async (bot, message, args) => {
 ...
 // if(!message.member.hasPermission("MANAGE_MEMBERS")) return message.reply("No can do pal!");
  ...
  .setColor("#fc6400")
  .addField("Verwarnung ausgesprochen gegen", `<@${wUser.id}>`)
  .addField("wurde gewarnt in", message.channel)
  .addField("Anzah der Warnungen", warns[wUser.id].warns.length + 1)
...
module.exports.help = {
  name: "warn",
  description:"Verwarnt einen Benutzer | warn @Benutzer Grund"
}